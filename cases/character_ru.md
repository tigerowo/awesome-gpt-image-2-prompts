...
| Результат |
| :----: |
| <a href="../images/character_case1/output.jpg" target="_blank" rel="noopener noreferrer"><img src="../images/character_case1/output.jpg" width="300" alt="Результирующее изображение"></a> |
...
| Результат |
| :----: |
| <a href="../images/character_case2/output.jpg" target="_blank" rel="noopener noreferrer"><img src="../images/character_case2/output.jpg" width="300" alt="Результирующее изображение"></a> |
...
| Результат |
| :----: |
| <a href="../images/character_case3/output.jpg" target="_blank" rel="noopener noreferrer"><img src="../images/character_case3/output.jpg" width="300" alt="Результирующее изображение"></a> |
...
| Результат |
| :----: |
| <a href="../images/character_case5/output.jpg" target="_blank" rel="noopener noreferrer"><img src="../images/character_case5/output.jpg" width="300" alt="Результирующее изображение"></a> |
...
| Результат |
| :----: |
| <a href="../images/character_case7/output.jpg" target="_blank" rel="noopener noreferrer"><img src="../images/character_case7/output.jpg" width="300" alt="Результирующее изображение"></a> |
...
| Результат |
| :----: |
| <a href="../images/character_case8/output.jpg" target="_blank" rel="noopener noreferrer"><img src="../images/character_case8/output.jpg" width="300" alt="Результирующее изображение"></a> |
...
| Результат |
| :----: |
| <a href="../images/character_case9/output.jpg" target="_blank" rel="noopener noreferrer"><img src="../images/character_case9/output.jpg" width="300" alt="Результирующее изображение"></a> |
...
| Результат |
| :----: |
| <a href="../images/character_case10/output.jpg" target="_blank" rel="noopener noreferrer"><img src="../images/character_case10/output.jpg" width="300" alt="Результирующее изображение"></a> |
...
| Результат |
| :----: |
| <a href="../images/character_case11/output.jpg" target="_blank" rel="noopener noreferrer"><img src="../images/character_case11/output.jpg" width="300" alt="Результирующее изображение"></a> |
...
| Результат |
| :----: |
| <a href="../images/character_case12/output.jpg" target="_blank" rel="noopener noreferrer"><img src="../images/character_case12/output.jpg" width="300" alt="Результирующее изображение"></a> |
...
| Результат |
| :----: |
| <a href="../images/character_case13/output.jpg" target="_blank" rel="noopener noreferrer"><img src="../images/character_case13/output.jpg" width="300" alt="Результирующее изображение"></a> |
...
| Результат |
| :----: |
| <a href="../images/character_case14/output.jpg" target="_blank" rel="noopener noreferrer"><img src="../images/character_case14/output.jpg" width="300" alt="Результирующее изображение"></a> |
...
| Результат |
| :----: |
| <a href="../images/character_case15/output.jpg" target="_blank" rel="noopener noreferrer"><img src="../images/character_case15/output.jpg" width="300" alt="Результирующее изображение"></a> |
...
| Output |
| :----: |
| <a href="../images/character_case24/output.jpg" target="_blank" rel="noopener noreferrer"><img src="../images/character_case24/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - Лист движений корейского танца"></a> |
...
| Output |
| :----: |
| <a href="../images/character_case25/output.jpg" target="_blank" rel="noopener noreferrer"><img src="../images/character_case25/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - Постер персонажа «Светоносный архивариус»"></a> |
...
| Результат |
| :----: |
| <a href="../images/character_case26/output.jpg" target="_blank" rel="noopener noreferrer"><img src="../images/character_case26/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - Профиль персонажа визуальной новеллы"></a> |
...
<!-- Case 28: Персонаж банановый герой Pixar (by @iamaiistudio) -->
### Case 28: [Персонаж банановый герой Pixar](https://x.com/iamaiistudio/status/2068003049600380972) (by [@iamaiistudio](https://x.com/iamaiistudio))

| Output |
| :----: |
| <a href="../images/character_case28/output.jpg" target="_blank" rel="noopener noreferrer"><img src="../images/character_case28/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - Банановый герой в стиле Pixar"></a> |
...
<!-- Case 29: Пастельные кавайные животные компаньоны (by @Taaruk_) -->
### Case 29: [Пастельные кавайные животные компаньоны](https://x.com/Taaruk_/status/2068351521016955098) (by [@Taaruk_](https://x.com/Taaruk_))

| Результат |
| :----: |
| <a href="../images/character_case29/output.jpg" target="_blank" rel="noopener noreferrer"><img src="../images/character_case29/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - Пастельные кавайные зверята-компаньоны"></a> |
...
<!-- Case 30: Коллекционная фигурка LEGO футбол (by @ChillaiKalan__) -->
### Case 30: [Коллекционная фигурка LEGO футбол](https://x.com/ChillaiKalan__/status/2068717001145778630) (by [@ChillaiKalan__](https://x.com/ChillaiKalan__))

<table>
<tr><td width="50%"><a href="../images/character_case30/output.jpg" target="_blank" rel="noopener noreferrer"><img src="../images/character_case30/output.jpg" width="100%" alt="GPT-Image-2 Prompt Example - Коллекционная футбольная фигурка LEGO"></a></td><td width="50%"><a href="../images/character_case30/output2.jpg" target="_blank" rel="noopener noreferrer"><img src="../images/character_case30/output2.jpg" width="100%" alt="GPT-Image-2 Prompt Example - Коллекционная футбольная фигурка LEGO"></a></td></tr>
<tr><td width="50%"><a href="../images/character_case30/output3.jpg" target="_blank" rel="noopener noreferrer"><img src="../images/character_case30/output3.jpg" width="100%" alt="GPT-Image-2 Prompt Example - Коллекционная футбольная фигурка LEGO"></a></td><td width="50%"><a href="../images/character_case30/output4.jpg" target="_blank" rel="noopener noreferrer"><img src="../images/character_case30/output4.jpg" width="100%" alt="GPT-Image-2 Prompt Example - Коллекционная футбольная фигурка LEGO"></a></td></tr>
</table>
...
```
<!-- Case 31: Кинематографический лист дизайна персонажа (by @MrLarus) -->
### Case 31: [Кинематографический лист дизайна персонажа](https://x.com/MrLarus/status/2053327334636208446) (by [@MrLarus](https://x.com/MrLarus))
...
```
<!-- Case 32: Трёхпанельный референс персонажа (by @johnAGI168) -->
### Case 32: [Трёхпанельный референс персонажа](https://x.com/johnAGI168/status/2078089955247632740) (by [@johnAGI168](https://x.com/johnAGI168))

| Output |
| :----: |
| <a href="../images/character_case32/output.webp" target="_blank" rel="noopener noreferrer"><img src="../images/character_case32/output.webp" width="300" alt="Output image"></a> |

**Промпт:**

```
基于所附参考图，生成一张三格人物设定参考图。构图为一个横向画面，等分为三个并排的竖直分格 (three-panel character reference sheet)，格与格之间是干净纤细的分隔线。严格保持参考图中人物的面部、发型发色、身材比例、服装造型、配饰完全一致，三格中为同一人物、同一套造型。

左格 —— 正面全身，无头。人物身体正对镜头，从肩部以下直到脚部，双臂自然垂放身侧，双手放松张开，重心均匀落在双脚。没有头部、没有头发——没有任何东西高出肩线，胸前与肩上没有头发垂落。颈部在喉咙根部以一条干净、平整、边缘清晰的水平切口收束，如同无头人台模特，利落的雕塑感切边，不模糊、不虚化、不消散、无烟雾、无残影、无透明、无血迹、无解剖细节；切口之上只有空白背景。此格保留完整头顶空间，肩线上方留有充足空白，使人物在画面中的比例与位置与正常全身像一致。

中格 —— 背面全身，带头。同一人物从正后方拍摄，站姿笔直，头发从背后自然垂落，服装背面构造、裙摆/裤型、鞋履清晰可见，双臂自然垂放身侧，双手放松，重心均匀落在双脚，从头顶到鞋子完整入镜。

右格 —— 齐胸大特写，身份锁定。同一人物从头顶略上方到锁骨、仅露出服装最上缘的紧凑构图，脸部占据画面大部分，真正的近景特写。身体正对镜头，头部平视，双眼直视镜头，双唇闭合放松，中性克制的神情。眉眼、睫毛、唇部质感与关键身份标记在近距离下清晰可辨。

三格统一背景：平坦均匀的 18% 中灰无缝背景，单一色值，无渐变无衰减 (flat 18% gray seamless)。无方向无阴影的正面照明，四周补光均匀一致，无主光侧、无阴影侧、无轮廓光、无边缘光 (shadowless frontal illumination)，背景无任何投影，脚下无接触阴影 (zero cast shadow)，三格光照完全一致。

真实照片级质感 (photorealistic)，皮肤可见细腻均匀毛孔与次表面散射，发丝根根分明，织物纹理清晰 (fabric weave)，轻微胶片颗粒。真实人类，真实相机拍摄，绝非塑料感、绝非渲染、绝非 CGI、无 AI 磨皮、无过度平滑
```
<!-- Case 33: Портрет с девятью вариантами мимики (by @TIGER) -->
### Case 33: [Портрет с девятью вариантами мимики](#) (by @TIGER)

| Output |
| :----: |
| <img src="../images/character_case33/output.webp" width="300" alt="Output image"> |
