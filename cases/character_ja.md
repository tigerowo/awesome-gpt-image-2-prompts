...
| 出力 |
| :----: |
| <a href="../images/character_case27/output.jpg" target="_blank" rel="noopener noreferrer"><img src="../images/character_case27/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - 中世の錬金術師キャラクターシート"></a> |
...
| Output |
| :----: |
| <a href="../images/character_case28/output.jpg" target="_blank" rel="noopener noreferrer"><img src="../images/character_case28/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - ピクサー風バナナのヒーローキャラクター"></a> |
...
| Output |
| :----: |
| <a href="../images/character_case29/output.jpg" target="_blank" rel="noopener noreferrer"><img src="../images/character_case29/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - パステルかわいい動物コンパニオン"></a> |
...
<!-- Case 31: 映画キャラクターデザインボード (by @MrLarus) -->
### Case 31: [映画キャラクターデザインボード](https://x.com/MrLarus/status/2053327334636208446) (by [@MrLarus](https://x.com/MrLarus))
...
```
<!-- Case 32: 3分割キャラクター設定資料 (by @johnAGI168) -->
### Case 32: [3分割キャラクター設定資料](https://x.com/johnAGI168/status/2078089955247632740) (by [@johnAGI168](https://x.com/johnAGI168))
